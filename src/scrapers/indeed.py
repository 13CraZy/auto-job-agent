        ...
        async with async_playwright() as p:
            ...
            for kw in search_terms:
                for loc in locations:
                    ...
                    search_url = f"{self.base_url}/ofertas?q={encoded_kw}&l={encoded_loc}&fromage={fromage_days}"
